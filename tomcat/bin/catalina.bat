...
rem Setup var for Castor configuration file
set JAVA_OPTS=%JAVA_OPTS% -Xms64m -Xmx256m -Didmuserapp.logging.config.dir="%CATALINA_HOME%/conf" -Dlog.init.file=idmrmap_logging.xml
